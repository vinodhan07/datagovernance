...
from src.domain.entities import QualityRule, QualityScan, QualityFinding
from src.domain.schemas import (
    QualityRuleCreate, QualityRuleOut,
    QualityScanOut, QualityScanDetailOut, QualityFindingOut,
    QualityScoreOut,
)
from src.modules.guardian.soda_scanner import build_sodacl_yaml, run_scan
...
async def _scan_sse(integration_id: str, db: Session):
    ...
    try:
        ...
        if not rules:
            ...
            from src.domain.entities import LineageDataset, LineageJob
            datasets = (
